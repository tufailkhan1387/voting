...
export const SidebarData = [
  ...
  },
  {
    label: "Constituency",
    submenuOpen: true,
    submenuHdr: "Constituency",
    submenu: false,
    showSubRoute: false,
    submenuItems: [
      {
        label: "Manage Constituency",
        link: "/sales-list",
    ...
    submenuItems: [
      {
        ...
        icon: <Icon.FileText />,
        submenuItems: [
          { label: "Results", link: "/expense-list", showSubRoute: false },
          {
            label: "Summary",
